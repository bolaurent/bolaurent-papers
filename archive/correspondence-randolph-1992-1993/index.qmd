...
<span class="redact__quote">"Fig. 7. D: Specimen clearly demonstrates the large amount of clitoral tissue which lies beneath the skin and must be removed."</span><span class="redact__src">Gross, Randolph &amp; Crigler, &ldquo;Clitorectomy for sexual abnormalities: indications and technique,&rdquo; Surgery 59 (1966), Fig.&nbsp;7, p.306.</span><span class="redact__note">The original reproduces four operative photographs during clitorectomy, redacted here by the editor. They are disturbing; consult R1 to view the source.</span>

:::

<style>
/* #fig-redact — Quarto now supplies the "Figure N" label; we only style it. */
#fig-redact{ margin: 2.75rem auto; max-width: 28rem; }
#fig-redact figure{ margin: 0; }
#fig-redact .redact__plate{
  display: block; width: 100%; height: auto;
  border: 1px solid #dcd9d0;
}
/* The auto-generated caption. The number prefix inherits this base style
   (oxblood mono, as the old .redact__fig span did); the quote/src/note
   spans below reset what they need to. Anchored on the #id, so it does not
   depend on Quarto's figcaption class name. */
#fig-redact figcaption{
  display: block; margin-top: 1.1rem; padding-top: 1rem;
  border-top: 3px solid #7a2e2e; text-align: left;
  font-family: "IBM Plex Mono", ui-monospace, monospace;
  font-size: 0.7rem; letter-spacing: 0.14em; text-transform: uppercase;
  color: #7a2e2e;
}
#fig-redact figcaption a{ color: inherit; text-decoration: none; }
#fig-redact .redact__quote{
...
@media (max-width: 600px){
  #fig-redact{ max-width: none; }
  #fig-redact .redact__quote{ font-size: 1.2rem; }
}
</style>
